...
#     cap = cv2.VideoCapture('https://dm0qx8t0i9gc9.cloudfront.net/watermarks/video/piShJKb/videoblocks-tel-aviv-israel-january-2018-passengers-walking-through-airport-terminal_rxbjdf5pm__2c365d4ce0ca2c27df6c887d19cd79f7__P360.mp4')
...
#
#                     # Check if the object is a "person"
#                 if class_name == "suitcase" and conf > 0.2:
#                     # Increment the count of detected chair
#                     detected_suitcase_count += 1
#
#                     # Bounding box
#                     x1, y1, x2, y2 = box.xyxy[0]  # output is in tensors
#                     # print(x1, y1, x2, y2)
...
#                 cv2.putText(img, f"Suitcase Count: {detected_suitcase_count}", (10, 80), cv2.FONT_HERSHEY_SIMPLEX,
#                             0.7, (255, 255, 255), 2)
#
#
#                 # Display or log the count of detected people
#                 print(f"Detected People: {detected_people_count}")
#                 print(f"Detected Suitcase: {detected_suitcase_count}")
#
#         yield img
